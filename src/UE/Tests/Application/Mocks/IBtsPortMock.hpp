...
public:
    ...
    MOCK_METHOD(void, handleSmsReceived, (common::PhoneNumber from, const std::string& text), ());
};
...
public:
    ...
    MOCK_METHOD(void, sendCallMessage, (common::MessageId msgId, common::PhoneNumber to), ());
